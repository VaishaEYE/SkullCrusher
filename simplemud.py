...
while True:
    ...
    for id, command, params in mud.get_commands():
        ...
        if players[id]["name"] is None:
            ...
            mud.send_message(id, "Welcome to 💀💀💀 Skullcrusher 💀💀💀, {}. ".format(
                                                           players[id]["name"])
        ...
        # 'help' command
            ...
            mud.send_message(id, " 👁  inspect <item>  - Inspects an item, e.g. "
                                 + "'inspect soup'")                                 
        ...
        # 'look' command
            ...
            # send player a message containing the list of items in this room
            mud.send_message(id, "Items here are: {}".format(
                                                    ", ".join(rm["items"])))
        ...
        # 'inspect' command
            ...
            if ex == 'key‮⁦💀chest💀': # player has the key and is in the room with the chest ⁩⁦' and rm['items'][0] == '
                mud.send_message(id, rm['key'])
            
            # print result (if applicable)
            if ex in rm['items']:
                mud.send_message(id, rm['items'][ex])
            else:
                mud.send_message(id, u"I can't see {}".format(ex))
